...
/**
 * Interface for creating and filling OWL 2.0 ontologies with the org.semanticweb.owlapi library.
 */
public interface OntologyAPI {
    /**
     * Creates a new OWL ontology. Must be called before any other method which adds something to an
     * ontology.
     *
     ...
     * To create a new ontology, call {@link #createOntology(String, String)} again. No method of
     * this interface which adds something to an ontology must be called until a new ontology has
     * been created.
     */
    public void removeOntology();

    /**
     * Adds an OWL axiom to this ontology which states that the OWL class "subClass" is the sub
     * class of
     *
    ...
    /**
     * Adds an axiom to the ontology which states that the two given OWL object properties are in a
     ...
     */
    public void addSubPropertyOfAxiom(
            OWLObjectProperty subProperty, OWLObjectProperty superProperty);
    ...
    /**
     * Adds axioms to the ontology, which state that the domain of the given property is the given
     * subject class and that its range is the given object class. Note that this is not a
     * "constraint" on the property but rather a statement used during inference.
     *
     ...
     */
    public void addDomainRangeAxiom(
            OWLClassExpression subject, OWLClassExpression object, OWLObjectProperty property);

    /**
     * Returns an OWL class expression which represents the set of individuals which have only
     * "role" properties where the object is from the class "concept". Example: role="makes-sound"
     * concept="Bark" -> a class of objects which can only make "Bark" sounds.
     *
     * @param role The property used in the expression.
     * @param concept The class of objects used in the expression.
     * @return The class expression.
     */
    public OWLClassExpression createOnlyRestriction(
            OWLObjectProperty role, OWLClassExpression concept);
     ...
     * individual and a literal) with the given name. However, the given property name is lemmatized
     * before use.
     *
    ...
    /**
     * Returns an OWL restriction which states that the given OWL property "role" must exist at
     * least once with an object from the OWL class "expression"
     *
     * @param role The property which is restricted.
     * @param expression The class of the objects to which the restriction applies.
     * @return The restriction.
     */
    public OWLClassExpression createSomeValuesFrom(
            OWLObjectProperty role, OWLClassExpression expression);
    ...
    /**
     * Adds an axiom to the ontology which states that the given property does not apply to the
     * "subject" class when the object is from the "object" class. Example: subject="Cat"
     * property="makes-sound" object="Bark" adds an axiom which implies that (if no other axioms are
     * present) everything which does not make a sound from the class "Bark" can be considered as a
     * "Cat".
     *
     ...
     */
    public void addNegationAxiom(
            OWLClassExpression subject, OWLClassExpression object, OWLObjectProperty property);

    /**
     * Adds an axiom to the ontology which states that the given classes are disjoint, i.e. that it
     * is a subset of the complement of the second class.
     *
    ...
    /**
     * Returns an OWL class expression which states that the given property "relation" must be
     * present at most "count" times for the instances of the OWL class "object".
     *
     ...
     */
    public OWLClassExpression createMaxCardinalityRestrictionAxiom(
            OWLClassExpression object, OWLObjectProperty relation, int count);

    /**
     * Returns an OWL class expression which states that the given property "relation" must be
     * present at least "count" times for the instances of the OWL class "object".
     *
     * @param object The object to which the constraint applies.
     * @param relation The property to which the constrain applies.
     ...
     * @return The corresponding class expression.
     */
    public OWLClassExpression createMinCardinalityRestrictionAxiom(
            OWLClassExpression object, OWLObjectProperty relation, int count);

    /**
     * Returns an OWL class expression which states that the given property "relation" must be
     * present exactly "count" times for the instances of the OWL class "object".
     *
     * @param object The object to which the constraint applies.
     * @param relation The property to which the constrain applies.
     ...
     * @return The corresponding class expression.
     */
    public OWLClassExpression createExactCardinalityRestrictionAxiom(
            OWLClassExpression object, OWLObjectProperty relation, int count);
     ...
     */
    public void addObjectPropertyAssertion(
