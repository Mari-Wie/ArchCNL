...
public class OWLAPIImpl implements OntologyAPI {
    ...
    public void addDomainRangeAxiom(
        ...
        OWLObjectPropertyDomainAxiom domainAxiom =
                df.getOWLObjectPropertyDomainAxiom(property, subject);

        OWLObjectPropertyRangeAxiom rangeAxiom =
                df.getOWLObjectPropertyRangeAxiom(property, object);
    ...
    public void addObjectPropertyAssertion(
        ...
        OWLAxiom objectPropertyAxiom =
                df.getOWLObjectPropertyAssertionAxiom(relation, individual, otherIndividual);
