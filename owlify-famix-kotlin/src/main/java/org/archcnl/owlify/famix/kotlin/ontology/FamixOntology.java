...
public class FamixOntology {
    ...
    public Individual getFamixClassWithName(String className) {
        ...
        if (!famixTypeIndividualCache.containsKey(className)) {
            Individual individual =
                    classesAndProperties.getFamixClassIndividual(model, className, typeID);
    ...
    public Individual getEnumTypeIndividualWithName(String enumTypeName) {
        if (!famixTypeIndividualCache.containsKey(enumTypeName)) {
            Individual individual =
                    classesAndProperties.getEnumTypeIndividual(model, enumTypeName, typeID);
    ...
    public Individual createAnnotationTypeAttributeIndividual() {
        return classesAndProperties.getAnnotationTypeAttributeIndividual(
    ...
    public Individual getInheritanceBetweenSubClassAndSuperClass(
            Individual superClassIndividual, Individual subClassIndividual) {
        Individual inheritance =
                classesAndProperties.getInheritanceIndividual(model, inheritanceID);
        inheritanceID++;
    ...
    public void setHasAnnotationTypeProperty(
    ...
    public void setDefinesMethodPropertyForFamixType(
    ...
    public void setDefinesParameterPropertyForBehavioralEntity(
    ...
    public void setHasDeclaredExceptionProperty(
    ...
    public void setExceptionHasDefiningClass(
    ...
    public void setHasCaughtExceptionProperty(
    ...
    public void setThrowsExceptionProperty(
    ...
    public Individual getAnnotationTypeAttributeOfAnnotationTypeByName(
    ...
    public void setHasAnnotationTypeAttributeForAnnotationInstanceAttribute(
    ...
    public void setHasAnnotationInstanceAttributeForAnnotationInstance(
    ...
    public void setHasValueForAnnotationInstanceAttribute(
    ...
    public void setHasFullQualifiedNameForType(
    ...
    public void setDefinesLocalVariableProperty(
