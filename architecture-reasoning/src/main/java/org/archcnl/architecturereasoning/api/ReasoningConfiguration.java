...
public class ReasoningConfiguration {
    ...
    private ReasoningConfiguration(
            String pathToData,
            String pathToMappingRules,
            String resultPath,
            List<String> pathToConcepts) {
    ...
    /**
     * Returns a list of all "concept file" paths. See {@link #withPathsToConcepts(List)} for
     * further details.
     */
    ...
    public static class ReasoningConfigurationBuilder {
         ...
         *
         * @param result the path to the OWL ontology file in which the resulting mapped model will
         *     be stored by the mapper.
         * @return this instance
         */
        ...
        /**
         * It is currently unclear what is a "concept" in the sense of this method. However, files
         * containing the architecture rules as OWL constraints are added with this method. So make
         * sure that you add them here. These concepts are currently added to the output ontology.
         *
         * @param paths A list of paths to "concept" files. This list should contain the paths of
         *     all architecture rule files (stored as OWL constraints).
         * @return this instance
         */
        ...
        public ReasoningConfiguration build() {
            return new ReasoningConfiguration(
                    pathToData, pathToMappingRules, resultPath, pathsToConcepts);
        }
    }
}
