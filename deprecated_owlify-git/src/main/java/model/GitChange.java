...
public class GitChange {
	...
	public boolean equals(final Object o) {
		...
		if (modificationKind != null ? !modificationKind.equals(gitChange.modificationKind)
				: gitChange.modificationKind != null)
			return false;

		if (relativePath != null ? !relativePath.equals(gitChange.relativePath) : gitChange.relativePath != null)
			return false;

		if (changeType != null ? !changeType.equals(gitChange.changeType) : gitChange.changeType != null)
			return false;
