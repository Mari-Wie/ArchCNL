...
public abstract class GenericVisitorTest<E extends VoidVisitorAdapter<Void>> {
    ...
    protected static final String PATH_TO_SRC = "./src/test/resources/";
    protected static final String PATH_TO_PACKAGE_WITH_TEST_EXAMPLES = PATH_TO_SRC + "examples/";
