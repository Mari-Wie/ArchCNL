...
public class ImportDeclarationVisitorTest extends GenericVisitorTest<ImportDeclarationVisitor> {
    ...
    @Test
    public void
            givenValidJavaClassFromSubpackage_whenImportDeclarationVisitorVisit_thenAllImportsFound()
                    throws FileNotFoundException, FileIsNotAJavaClassException {
        // given, when
        final List<String> imports =
                extractImportedTypes(
                        GenericVisitorTest.PATH_TO_PACKAGE_WITH_TEST_EXAMPLES
                                + GenericVisitorTest.TEST_SUBPACKAGE
                                + GenericVisitorTest.CLASS_A);
        // then
        Assert.assertEquals(3, imports.size());
    ...
    @Test
    public void
            givenValidJavaClass_whenImportDeclarationVisitorVisit_thenImportsAsSimpleNamesFound()
                    throws FileNotFoundException, FileIsNotAJavaClassException {
        // given, when
        final List<String> imports =
    ...
    @Test
    public void
            givenValidJavaClass_whenImportDeclarationVisitorVisit_thenStaticImportsAsSimpleNamesFound()
                    throws FileNotFoundException, FileIsNotAJavaClassException {
        // given, when
        final List<String> imports =
                extractImportedSimpleNames(
