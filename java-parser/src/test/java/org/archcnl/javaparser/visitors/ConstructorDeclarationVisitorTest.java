...
public class ConstructorDeclarationVisitorTest
  ...
  @Test
  public void givenJavaClassWithComplexConstructors_whenConstructorVisitorClassVisit_thenFirstClassConstructorFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given
    final CompilationUnit unit = CompilationUnitFactory.getFromPath(
    ...
    Assert.assertEquals("java.lang.Exception",
        constructor1.getDeclaredExceptions().get(0).getName());
    Assert.assertEquals("Exception", constructor1.getDeclaredExceptions().get(0).getSimpleName());
  ...
  @Test
  public void givenJavaClassWithComplexConstructors_whenConstructorVisitorClassVisit_thenSecondClassConstructorFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given
    final CompilationUnit unit = CompilationUnitFactory.getFromPath(
        GenericVisitorTest.PATH_TO_PACKAGE_WITH_TEST_EXAMPLES + GenericVisitorTest.COMPLEX_CLASS);
