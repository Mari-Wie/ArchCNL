...
public class NormalAnnotationVisitorTest
  ...
  public void setUp() throws FileNotFoundException, FileIsNotAJavaClassException {
    ...
    complexClass = unit.getClassByName(GenericVisitorTest.COMPLEX_CLASS.substring(0,
        GenericVisitorTest.COMPLEX_CLASS.indexOf("."))).get();
    final CompilationUnit enumUnit = CompilationUnitFactory.getFromPath(
        GenericVisitorTest.PATH_TO_PACKAGE_WITH_TEST_EXAMPLES + GenericVisitorTest.ENUM);
    enumType = enumUnit
        .getEnumByName(GenericVisitorTest.ENUM.substring(0, GenericVisitorTest.ENUM.indexOf(".")))
        .get();
  }

  @Test
  public void givenValidJavaClassWithMethodAnnotationWithConstantInParam_whenAnnotationVisitorVisit_thenAnnotationWithReplacedValueFound()
  ...
  @Test
  public void givenValidJavaClassWithMethodAnnotationWithMultipleParams_whenAnnotationVisitorVisit_thenAnnotationFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  @Test
  public void givenValidJavaClassWithParamAnnotation_whenAnnotationVisitorVisit_thenAnnotationWithoutValuePairButWithParenthesesFound() {
    // given, when
  ...
  @Test
  public void givenValidJavaClassWithMethodWithoutNonNormalAnnotations_whenAnnotationVisitorVisit_thenNoNormalMethodAnnotationsFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  @Test
  public void givenValidJavaClassWithMethodWithoutAnnotations_whenAnnotationVisitorVisit_thenNoMethodAnnotationsFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  @Test
  public void givenValidJavaClassWithAnnotations_whenAnnotationVisitorVisit_thenTypeAnnotationFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  @Test
  public void givenValidEnumWithMethodsAnnotations_whenAnnotationVisitorVisit_thenMethodAnnotationFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  @Test
  public void givenValidJavaTypeWithMethodAnnotationWithNullConstantInParam_whenAnnotationVisitorVisit_thenAnnotationWithNullValueFound()
      throws FileNotFoundException, FileIsNotAJavaClassException {
    // given, when
  ...
  private List<AnnotationInstance> visit(final List<AnnotationExpr> annotationExpressions) {
    return annotationExpressions.stream().map(a -> {
