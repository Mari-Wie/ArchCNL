  ...
  public void visit(final ThrowStmt n, final Void arg) {
    ...
    if (thrownException == null) {
      ThrowStatementVisitor.LOG.debug(
          "Throw statement does not match \"throw new X()\", using fall back solution: " + n);
      ...
      try {
        ...
        thrownException = new Type(typeName, simpleName, false); // primitives types cannot be
                                                                 // thrown
        ...
        ThrowStatementVisitor.LOG
            .error("An exception was used that javaparser can not reach: " + throwExpression, e);
      }
    }
