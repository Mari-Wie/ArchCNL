...
public class AccessVisitor extends VoidVisitorAdapter<Void> {
    ...
    //        //		Individual type =
    // ontology.getFamixClassWithName(n.getType().getName().toString());
    //        try {
    //            ResolvedReferenceType resolvedType = n.getType().resolve();
    //            //            Individual type =
    //            // ontology.getFamixClassWithName(resolvedType.getQualifiedName());
    //            Individual type =
    // ontology.getReferenceTypeIndividual(resolvedType.getQualifiedName());
    //
    ...
    //
    //            //            Individual receiver =
    // ontology.getLocalVariableIndividual(declaringType);
