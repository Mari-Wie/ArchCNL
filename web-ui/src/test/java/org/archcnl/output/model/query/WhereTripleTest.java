...
public class WhereTripleTest {
  ...
  public void givenWhereTripleWithField_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
  ...
  @Test
  public void givenWhereTripleWithPrimitiveValueString_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
  ...
  @Test
  public void givenWhereTripleWithPrimitiveValueInt_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
  ...
  @Test
  public void givenWhereTripleWithPrimitiveValueDouble_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
        new QueryPredicate(QueryNamesapace.XSD, "hasName"),
  ...
  @Test
  public void givenWhereTripleWithPrimitiveValueBoolean_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
        new QueryPredicate(QueryNamesapace.XSD, "hasName"),
  ...
  @Test
  public void givenWhereTripleWithPrimitiveValueDateTime_whenCallAsFormattedString_thenReturnFormattedString() {
    // given
    final WhereTriple triple = new WhereTriple(new QueryField("aggregate"),
        new QueryPredicate(QueryNamesapace.XSD, "hasName"),
        new QueryObject("2020-08-28T21:12:00", QueryObjectType.PRIMITIVE_VALUE));

    final String expectedString = "?aggregate xsd:hasName \"2020-08-28T21:12:00\"^^xsd:dateTime";
