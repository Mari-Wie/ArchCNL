...
public class OpenRulePresetsDialog extends Dialog {
	...
	private void updateDialog(ArchitecturalStyle architecturalStyle) {
		...
		ArchitecturalStyleConfig architecture = new ArchitecturalStyleConfigManager().build(architecturalStyle);
		...
		if (architecture != null) {
			...
			dialogLayout.add(Notification.show(architecturalStyle.toString() + " is not yet implemented", 5000,
