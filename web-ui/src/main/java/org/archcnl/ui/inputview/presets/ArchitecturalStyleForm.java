...
public class ArchitecturalStyleForm extends Component implements HasComponents, HasSize, PropertyChangeListener {
...
//        addRuleBoxToUi(architecturalStyleConfig.getRules());
	...
	private void addFooter() {
		...
		Button saveBtn = new Button("Create Rules & Mappings",
