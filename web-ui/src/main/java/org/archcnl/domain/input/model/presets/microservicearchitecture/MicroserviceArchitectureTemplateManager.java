 ...
 * architectural Style.
 */
public class MicroserviceArchitectureTemplateManager {

    // variables
    private Variable classVariable;
    private Variable class2Variable;
    private Variable classPackage;
    private Variable class2Package;
    private Variable nameVariable;
    private Variable registryVariable;
    private Variable registryImportVariable;
    private Variable registryImportNameVariable;
    private Variable methodVariable;
    ...
    public CustomConcept createMicroservicesConceptAndMapping(Set<TwoColumnGridEntry> services) {
        ...
        for (Iterator<TwoColumnGridEntry> iterator = services.iterator(); iterator.hasNext(); ) {
            TwoColumnGridEntry microserviceEntry = (TwoColumnGridEntry) iterator.next();
    ...
    public CustomConcept createDbAccessAbstractionConceptAndMapping(Set<TwoColumnGridEntry> set) {
        ...
        for (Iterator<TwoColumnGridEntry> iterator = set.iterator(); iterator.hasNext(); ) {
            TwoColumnGridEntry dbAccessAbstraction = (TwoColumnGridEntry) iterator.next();
    ...
    public CustomConcept createApiMechanismsConceptAndMapping(Set<TwoColumnGridEntry> set) {
        ...
        regexExp.append("(\\\\w||\\\\W)*");
        for (Iterator<TwoColumnGridEntry> iterator = set.iterator(); iterator.hasNext(); ) {
            TwoColumnGridEntry apiMechanismEntry = (TwoColumnGridEntry) iterator.next();
