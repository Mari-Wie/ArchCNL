...
public class RelationManager {
    ...
    public void addOrAppend(final CustomRelation relation) throws UnrelatedMappingException {
        try {
            ...
            // cannot occur
            throw new RuntimeException("Adding and appending of of mapping \"" + relation.getName()
                    + "\" failed unexpectedly.");
        }
    }
    ...
    public boolean doesRelationExist(final Relation relation) {
        return relations.stream().anyMatch(
    ...
    private void initializeSpecialRelations() {
        ...
        relations.add(new JenaBuiltinRelation("matches", "regex",
    ...
    private void initializeStringRelations() {
        final List<ActualObjectType> stringConcept = new LinkedList<>();
        stringConcept.add(new StringValue(""));
        relations.add(new FamixRelation("hasModifier",
        ...
        relations.add(new FamixRelation("hasValue",
                ...
                stringConcept));
        relations.add(new FamixRelation("hasFullQualifiedName",
    ...
    private void initializeBoolRelations() {
        ...
        relations.add(new FamixRelation("isConstructor",
    ...
    private void initializeObjectRelations(final ConceptManager conceptManager)
        ...
        relations.add(new FamixRelation("definesParameter",
        ...
        relations.add(new FamixRelation("definesVariable",
        ...
        relations.add(new FamixRelation("hasAnnotationInstance",
        ...
        relations.add(new FamixRelation("hasAnnotationType",
        ...
        annotationTypeAttributeConcept
                .add(extractConcept(conceptManager, "AnnotationTypeAttribute"));
        relations.add(new FamixRelation("hasAnnotationTypeAttribute",
        ...
        annotationInstanceAttributeConcept
                .add(extractConcept(conceptManager, "AnnotationInstanceAttribute"));
        relations.add(new FamixRelation("hasAnnotationInstanceAttribute",
        ...
        relations.add(new FamixRelation("definesAttribute",
        ...
        relations.add(new FamixRelation("definesMethod",
        ...
        relations.add(new FamixRelation("imports",
        ...
        relations.add(new FamixRelation("definesNestedType",
        ...
        relations.add(new FamixRelation("namespaceContains",
        ...
        relations.add(new FamixRelation("hasDeclaredType",
    ...
    private void initializeConformanceRelations(final ConceptManager conceptManager)
        ...
        relations.add(new ConformanceRelation("hasRuleRepresentation",
        ...
        relations.add(new ConformanceRelation("hasRuleType",
                "This relation is used to state that the subject (for example architecture rule) has a specified in the object rule type.",
                new ArrayList<>(Arrays.asList(new StringValue("")))));
        relations.add(new ConformanceRelation("hasNotInferredStatement",
                "This relation is used to state that the subject hasn't / doesn't correspond to the specified in the object statements.",
                new ArrayList<>(
                        Arrays.asList(extractConcept(conceptManager, "NotInferredStatement")))));
        relations.add(new ConformanceRelation("hasAssertedStatement",
                "This relation is used to state that the subject has / corresponds to the specified in the object statements.",
                new ArrayList<>(
                        Arrays.asList(extractConcept(conceptManager, "AssertedStatement")))));
        relations.add(new ConformanceRelation("hasSubject",
        ...
        relations.add(new ConformanceRelation("validates",
    ...
    private Concept extractConcept(final ConceptManager conceptManager, final String conceptName)
            throws ConceptDoesNotExistException {
        return conceptManager.getConceptByName(conceptName)
                .orElseThrow(() -> new ConceptDoesNotExistException(conceptName));
    }

    public List<Relation> getInputRelations() {
        return relations.stream().filter(Predicate.not(ConformanceRelation.class::isInstance))
                .collect(Collectors.toList());
    }

    public List<Relation> getOutputRelations() {
        return relations.stream().filter(Predicate.not(JenaBuiltinRelation.class::isInstance))
                .collect(Collectors.toList());
    }

    public List<CustomRelation> getCustomRelations() {
        return relations.stream().filter(CustomRelation.class::isInstance)
                .map(CustomRelation.class::cast).collect(Collectors.toList());
    }
