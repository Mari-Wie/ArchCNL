...
public class RelationManager extends HierarchyManager<Relation>{
    ...
    //TODO: fix this lazy coupout by removing it and refactoring the init functions. This function is only here because I was to lazy to fix all the init functions.
