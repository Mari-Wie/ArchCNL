...
public class MainOntologyRelation extends Relation implements FormattedQueryDomainObject {

    private static final String RELATION_TYPE = "main";

    public MainOntologyRelation(
            String name,
            String description,
