...
public class RelationManager {
	...
	private void initializeRelations() throws ConceptDoesNotExistException {
		...
		relations.add(new Relation("hasAnnotationInstance", RelationType.famix, annotationInstanceConcept));
		...
		annotationTypeAttributeConcept.add(conceptManager.getConceptByName("AnnotationTypeAttribute"));
		relations.add(new Relation("hasAnnotationTypeAttribute", RelationType.famix, annotationTypeAttributeConcept));
		
		// AnnotationInstanceAttribute relations
		List<Concept> annotationInstanceAttributeConcept = new LinkedList<>();
		annotationInstanceAttributeConcept.add(conceptManager.getConceptByName("AnnotationInstanceAttribute"));
		relations.add(new Relation("hasAnnotationInstanceAttribute", RelationType.famix, annotationInstanceAttributeConcept));
		...
		relations.add(new Relation("namespaceContains", RelationType.famix, namespaceContainsConcepts));
		...
		relations.add(new Relation("hasDeclaredType", RelationType.famix, typeAndprimitiveConcepts));
	}
