...
public class Relation {
	...
	/**
	 * Constructs a relation that relates to the given concept.
	 * RelationType.rdf should only be used if absolutely necessary.
	 * Concepts can be empty if relation supports all concepts as objects
	...
	/**
	 * Special constructor for the rdf:type relation (a.k.a. "is-of-type").
	 * Do not use this constructor for any other relations.
