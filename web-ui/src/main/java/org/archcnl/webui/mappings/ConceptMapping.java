...
public class ConceptMapping extends Mapping {
	...
	protected ConceptMapping(String name, Variable thenVariable, List<AndTriplets> whenTriplets, ConceptManager conceptManager,
			RelationManager relationManager) throws ConceptAlreadyExistsException, RelationDoesNotExistException, RelationCannotRelateToObjectException {
