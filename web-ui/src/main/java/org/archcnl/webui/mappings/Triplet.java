...
public class Triplet {
	...
	public Triplet(Variable subject, Relation predicate, Concept object) throws RelationCannotRelateToObjectException {
	...
	public Triplet(Variable subject, Relation predicate, Variable object) throws RecursiveRelationException {
		this.setSubject(subject);
		this.setPredicate(predicate);
		this.setObject(object);
	}
