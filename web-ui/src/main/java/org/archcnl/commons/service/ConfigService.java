...
public class ConfigService {
  ...
  public static String getDbUsername() throws PropertyNotFoundException {
    return ConfigService.checkIfPropertyPresent(
        ConfigService.getDbPropertyByName(ConfigService.DB_USER_NAME), ConfigService.DB_USER_NAME);
  }
  ...
  public static String getDbPassword() throws PropertyNotFoundException {
    return ConfigService.checkIfPropertyPresent(
        ConfigService.getDbPropertyByName(ConfigService.DB_PASSWORD), ConfigService.DB_PASSWORD);
  }
  ...
  private static String checkIfPropertyPresent(final Optional<String> optProperty,
      final String propertyName) throws PropertyNotFoundException {
  ...
  private static Optional<String> getDbPropertyByName(final String name) {
    ...
    try (final InputStream fis =
        ConfigService.class.getClassLoader().getResourceAsStream(ConfigService.PROPERTY_FILE)) {
      properties.load(fis);
