...
public class MainUI extends VerticalLayout {
    ...
    public MainUI() {
        ...
        Component mb = createHeader();
        Component c = createContent();
        Component f = createFooter();
        add(mb);
        addAndExpand(c);
        add(f);
    }
    ...
    private Component createContent() {
        ...
        vbox.setHeight(80, Unit.PERCENTAGE);
    ...
    private Component createFooter() {
        ...
        footerHbox.setHeight(10, Unit.PERCENTAGE);
        footerHbox.setWidth(100, Unit.PERCENTAGE);
