...
public class MainOntology {
    ...
    public enum MainOntClasses {
         ...
         * @param name A unique identifier of this individual. Must only be unique within the same ontology class.
         * @return The created individual.
         */
        public Individual create(OntModel model, String name) {
            String className = namespace + this.name();
            return model.getOntClass(className).createIndividual(className + "/" + name);
        }
    }
    ...
    public enum MainObjectProperties {
        ...
        public ObjectProperty get(OntModel model) {
            return model.getObjectProperty(namespace + this.name());
        }
    }
    ...
    public enum MainDatatypeProperties {
        ...
        public DatatypeProperty get(OntModel model) {
            return model.getDatatypeProperty(namespace + this.name());
        }
    }
     ...
     */
    /**
     * Models a software artifact file in this ontology. Software artifact files are all files which are
     * analyzed by "input parsers", e.g. a Maven pom.xml or a source code file.
     * @param path The path to the file or another unique identifier.
     * @param containedIndividuals A list of OWL individuals of "top level concepts" which are defined in the file, e.g. the top-level classes.
     */
    public void modelSoftwareArtifactFile(String path, List<Individual> containedIndividuals) {
        ...
        containedIndividuals.forEach(i -> artifact.addProperty(MainObjectProperties.containsArtifact.get(model), i));
    }
