...
/**
 * An in memory dummy "database" for the example purposes. In a typical Java app this class would be
 * replaced by e.g. EJB or a Spring based service class.
 *
 * <p>In demos/tutorials/examples, get a reference to this service class with {@link
...
public class CustomerService {
     ...
     *
     * @param stringFilter filter that returned objects should match or null/empty string if all
    ...
    /**
     * Persists or updates customer in the system. Also assigns an identifier for new Customer
     * instances.
     *
     * @param entry
     */
