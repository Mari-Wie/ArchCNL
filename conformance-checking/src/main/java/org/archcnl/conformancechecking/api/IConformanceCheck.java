...
public interface IConformanceCheck {
    ...
    /**
     * Loads the given OWL ontology file containing a code model and adds the given architecture
     * rule with its violations to it. The resulting model is stored in a new file. The path of this
     * file is specified by a parameter. {@link #createNewConformanceCheck()} must have been called
