...
public class ConformanceCheckImplTest {
  ...
  public void givenRulesAndViolations_whenCreatingOntModel_thenModelIsIsomorphicWithExpectedModel()
    ...
    expected.getProperty(ConformanceCheckOntologyClassesAndProperties
        .createIndividual(ConformanceCheckOntClasses.ConformanceCheck, expected), hasCheckingDate)
        .remove();
    ...
    actual
        .getProperty(ConformanceCheckOntologyClassesAndProperties
            .createIndividual(ConformanceCheckOntClasses.ConformanceCheck, actual), hasCheckingDate)
        .remove();
