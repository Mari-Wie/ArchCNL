...
class KotlinTypeVisitorTest {
    ...
    void givenKotlinClass_whenKotlinTypeVisitorVisit_thenTypeFound() throws IOException {
        ...
        Assertions.assertEquals(
                "referenceMethod(ClassInSubpackage?)", referenceMethod.getSignature());
        ...
        Assertions.assertEquals(
                "\"nicht mehr verwenden\"", deprecatedAnnotationValues.get(0).getValue());
    }

    @Test
    void givenKotlinClassInSubpackage_whenKotlinTypeVisitorVisit_thenTypeFound()
            throws IOException {
        // given
        final var namedFileContext =
    ...
    void givenKotlinClassWithInnerClass_whenKotlinTypeVisitorVisit_thenAllTypesFound()
        ...
        Assertions.assertEquals(
                "example.ClassWithInnerClass.InnerClass.InsideClass", insideClass.getName());
    }
    ...
    void givenKotlinInterface_whenKotlinTypeVisitorVisit_thenTypeFound() throws IOException {
        ...
        Assertions.assertEquals(
                "\"/some/url/otherStuff/{id}\"", firstNameValuePairFifthMethod.getValue());
    }
}
