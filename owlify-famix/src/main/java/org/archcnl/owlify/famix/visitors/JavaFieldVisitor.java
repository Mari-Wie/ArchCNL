    ...
    public void visit(FieldDeclaration n, Void arg) {
        ...
        for (VariableDeclarator variableDeclarator : n.getVariables()) {
            ...
            ontology.setHasNamePropertyForNamedEntity(
                    variableDeclarator.getName().asString(), fieldIndividual);
            ...
            ontology.setDeclaredTypeForBehavioralOrStructuralEntity(
                    fieldIndividual, visitor.getDeclaredType());
            ...
            for (AnnotationExpr annotationExpr : n.getAnnotations()) {
                annotationExpr.accept(
                        new MarkerAnnotationExpressionVisitor(ontology, fieldIndividual), null);
                annotationExpr.accept(
                        new SingleMemberAnnotationExpressionVisitor(ontology, fieldIndividual),
                        null);
                annotationExpr.accept(
                        new NormalAnnotationExpressionVisitor(ontology, fieldIndividual), null);
            }
        }
    }
}
