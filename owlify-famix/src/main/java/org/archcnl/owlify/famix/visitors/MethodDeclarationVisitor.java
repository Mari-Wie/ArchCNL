...
public class MethodDeclarationVisitor extends VoidVisitorAdapter<Void> {
    ...
    public void visit(MethodDeclaration n, Void arg) {
        ...
        ontology.setDeclaredTypeForBehavioralOrStructuralEntity(
                methodIndividual, visitor.getDeclaredType());
        ...
        for (AnnotationExpr annotationExpr : n.getAnnotations()) {
            annotationExpr.accept(
                    new MarkerAnnotationExpressionVisitor(ontology, methodIndividual), null);
            annotationExpr.accept(
                    new SingleMemberAnnotationExpressionVisitor(ontology, methodIndividual), null);
            annotationExpr.accept(
                    new NormalAnnotationExpressionVisitor(ontology, methodIndividual), null);
        }
        ...
        for (ReferenceType referenceType : n.getThrownExceptions()) {
            ...
            ontology.setExceptionHasDefiningClass(
                    declaredExceptionIndividual, thrownExceptionClass);
