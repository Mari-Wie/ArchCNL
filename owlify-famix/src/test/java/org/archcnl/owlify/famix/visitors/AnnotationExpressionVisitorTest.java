...
public class AnnotationExpressionVisitorTest {
    ...
    public void testMarkerAnnotationExpression()
        ...
        markerVisitor =
                new MarkerAnnotationExpressionVisitor(ontology, visitor.getFamixTypeIndividual());
        ...
        assertEquals(
                annotationType, annotationInstance.getProperty(hasAnnotationType).getResource());
