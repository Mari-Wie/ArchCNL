...
public class ThrowStatementVisitorTest {
    ...
    public void test() throws FileIsNotAJavaClassException {
        ...
        Individual exceptionType0 = ontology.getFamixClassWithName("java.lang.IllegalArgumentException");
        Individual exceptionType1 = ontology.getFamixClassWithName("java.lang.IllegalStateException");
       
        int matchingStatements = model.listStatements(currentUnitIndividual, throwsException, throw0).toList().size();
        assertEquals(1, matchingStatements);
        
        matchingStatements = model.listStatements(currentUnitIndividual, throwsException, throw1).toList().size();
        assertEquals(1, matchingStatements);
