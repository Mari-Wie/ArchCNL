...
public class ClassVistorTest {
    ...
    @Test
    public void testParserCreatesFamixClassIndividualForJavaClass()
        ...
        assertEquals(
                "FamixClass", classVisitor.getFamixTypeIndividual().getOntClass().getLocalName());
    }

    @Test
    public void testParserCreatesInterfaceIndividualForInterface()
            throws FileIsNotAJavaClassException {
    ...
    @Test
    public void testParserCreatesAnnotationIndividualForAnnotationDeclaration()
            throws FileIsNotAJavaClassException {
        ...
        assertEquals(
                "AnnotationType",
                classVisitor.getFamixTypeIndividual().getOntClass().getLocalName());
    }

    @Test
    public void testParserCreatesEnumIndividualForEnumDeclaration()
            throws FileIsNotAJavaClassException {
