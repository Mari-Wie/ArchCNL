...
public class ArchcnlGenerator extends AbstractGenerator {
  ...
  public void compile(final Sentence s) {
    ...
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + ruletype));
    ...
    ArchcnlGenerator.LOG.debug(("Processed sentence with ID " + Integer.valueOf(ArchcnlGenerator.id)));
    ArchcnlGenerator.id++;
  }
  
  public void compile(final SubConceptRuleType subconcept, final ConceptExpression subject) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling SubConceptRuleType ..."));
    final OWLClassExpression subjectConceptExpression = this.compile(subject);
    final OWLClass object = this.api.createOWLClass(this.namespace, subconcept.getObject().getConcept().getConceptName());
  ...
  public void compile(final CardinalityRuleType cardrule, final ConceptExpression subject) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling CardinalityRuleType ..."));
    final OWLClassExpression subjectConceptExpression = this.compile(subject);
  ...
  public void compile(final NegationRuleType negation) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling NegationRuleType ..."));
    if ((negation instanceof Nothing)) {
      ...
      if (_tripleNotEquals) {
        OWLObjectProperty _createOWLObjectProperty = this.api.createOWLObjectProperty(this.namespace, 
  ...
  public void compile(final ConditionalRuleType conditional) {
    ...
    OWLObjectProperty subProperty = this.api.createOWLObjectProperty(this.namespace, conditional.getRelation().getRelationName());
    OWLObjectProperty superProperty = this.api.createOWLObjectProperty(this.namespace, conditional.getRelation2().getRelationName());
    this.api.addSubPropertyOfAxiom(subProperty, superProperty);
  }
  
  public void compile(final OnlyCanRuleType onlycan) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling OnlyCanRuleType ..."));
  ...
  public void compile(final CanOnlyRuleType canonly, final ConceptExpression subject) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling CanOnlyRuleType ..."));
    final OWLClassExpression subjectConceptExpression = this.compile(subject);
  ...
  public void compile(final MustRuleType must, final ConceptExpression subject) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling MustRuleType ... "));
    final OWLClassExpression subjectConceptExpression = this.compile(subject);
  ...
  public OWLClassExpression compile(final ObjectConceptExpression object) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling ObjectConceptExpression ..."));
    OWLObjectProperty _createOWLObjectProperty = this.api.createOWLObjectProperty(this.namespace, object.getRelation().getRelationName());
    final OWLObjectProperty relation = ((OWLObjectProperty) _createOWLObjectProperty);
    ...
    if (_equals) {
      ...
      if (_equals_1) {
        ...
        if (_equals_2) {
          ...
          return this.api.createExactCardinalityRestrictionAxiom(concept, relation, count);
        } else {
  ...
  public OWLClassExpression compile(final ConceptExpression conceptExpression) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling ConceptExpression ... "));
    final OWLClass conceptAsOWL = this.api.createOWLClass(this.namespace, conceptExpression.getConcept().getConceptName());
  ...
  public OWLClassExpression compile(final ThatExpression that) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling ThatExpression ..."));
    ...
    for (final StatementList statements : _list) {
      {
        ...
        if ((expression instanceof ConceptExpression)) {
          ...
          OWLObjectProperty _createOWLObjectProperty = this.api.createOWLObjectProperty(this.namespace, relation.getRelationName());
          final OWLObjectProperty thatRoleOWL = ((OWLObjectProperty) _createOWLObjectProperty);
          final OWLClassExpression owlexpression = this.compile(((ConceptExpression)expression));
          OWLClassExpression result = this.api.createSomeValuesFrom(thatRoleOWL, owlexpression);
          results.add(result);
        } else {
          if ((expression instanceof DataStatement)) {
            ...
            OWLDataProperty _createOWLDatatypeProperty = this.api.createOWLDatatypeProperty(this.namespace, relation_1.getRelationName());
            final OWLDataProperty thatRoleOWL_1 = ((OWLDataProperty) _createOWLDatatypeProperty);
            final String dataString = ((DataStatement)expression).getStringValue();
            if ((dataString != null)) {
              final OWLDataHasValue dataHasValue = this.api.createDataHasValue(dataString, thatRoleOWL_1);
              results.add(dataHasValue);
            } else {
              final OWLDataHasValue dataHasValue_1 = this.api.createDataHasValue(((DataStatement)expression).getIntValue(), thatRoleOWL_1);
  ...
  public void compile(final FactStatement fact) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling FactStatement ..."));
  ...
  public void compile(final ConceptAssertion fact) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling ConceptAssertion..."));
    OWLNamedIndividual individual = this.api.createNamedIndividual(this.namespace, fact.getIndividual());
    OWLClass concept = this.api.createOWLClass(this.namespace, fact.getConcept().getConceptName());
    this.api.addClassAssertionAxiom(individual, concept);
  }
  
  public void compile(final RoleAssertion fact) {
    ArchcnlGenerator.LOG.trace(((("ID " + Integer.valueOf(ArchcnlGenerator.id)) + ": ") + "compiling RoleAssertion..."));
    OWLNamedIndividual individual = this.api.createNamedIndividual(this.namespace, fact.getIndividual());
  ...
  public void compile(final ObjectPropertyAssertion fact) {
    OWLNamedIndividual individual = this.api.createNamedIndividual(this.namespace, fact.getIndividual());
    OWLObjectProperty relation = this.api.createOWLObjectProperty(this.namespace, fact.getRelation().getRelationName());
    OWLNamedIndividual otherIndividual = this.api.createNamedIndividual(this.namespace, fact.getIndividual2());
  ...
  public void compile(final DatatypePropertyAssertion fact) {
    OWLNamedIndividual individual = this.api.createNamedIndividual(this.namespace, fact.getIndividual());
    OWLDataProperty relation = this.api.createOWLDatatypeProperty(this.namespace, fact.getRelation().getRelationName());
    String _stringValue = fact.getStringValue();
    boolean _tripleNotEquals = (_stringValue != null);
    if (_tripleNotEquals) {
      this.api.addClassAssertionAxiom(individual, this.api.createDataHasValue(fact.getStringValue(), relation));
    } else {
      this.api.addClassAssertionAxiom(individual, this.api.createDataHasValue(fact.getIntValue(), relation));
    }
  }
}
