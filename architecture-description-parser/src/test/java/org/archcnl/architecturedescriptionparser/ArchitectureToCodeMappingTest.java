...
public class ArchitectureToCodeMappingTest {
	...
	private static final String rule1 = "foobar: (?class rdf:type test:Foo) (?class2 rdf:type test:Bar) -> (?class test:qux ?class2)";
	...
	@Test
	public void givenArchitectureToCodeMapping_whenWrittenToAStringWriter_thenStringWriterToStringEqualsExpectation()
			throws IOException {
		// given
