...
public class ArchitectureToCodeMappingTest {
	...
	private static final String rule1 = "foobar: (?class rdf:type " + testPrefix + ":Foo) (?class2 rdf:type "
			+ testPrefix + ":Bar) -> (?class " + testPrefix + ":qux ?class2)";
	...
	@Test
	public void givenArchitectureToCodeMapping_whenMappingIsReturnedAsSWRL_thenMappingEqualsExpectationString() throws IOException {
		//given, when
	...
	@Test
	public void givenEmptyArchitectureToCodeMapping_whenMappingIsReturned_thenMappingEqualsPrefix() throws IOException {
		//given, when
	...
	@Test
	public void givenArchitectureToCodeMapping_whenMappingIsWrittenToStringWriter_thenStringWriterToStringEqualsExpectationString() throws IOException {
		//given
		mapping = new ArchitectureToCodeMapping(prefixMapping, Arrays.asList(rule1, rule2));
		StringWriter writer = new StringWriter();
		//when
